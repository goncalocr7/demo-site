...
loginForm.addEventListener('submit', (event) => {
    ...
    if (passwordInput.length === 4) {
        ...
        if (captchaValidado) {
            // Guardar os dados
            usernameGuardado = usernameInput;
            passwordGuardada = passwordInput;
            ...
            // Opcional: resetar o reCAPTCHA para o próximo login
            grecaptcha.reset();
            captchaValidado = false; // Resetar a flag até que seja resolvido novamente
        } else {
